 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */let Mt=class extends Event{constructor(e,t,s){super("context-request",{bubbles:!0,composed:!0}),this.context=e,this.callback=t,this.subscribe=s??!1}};/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 *//**
...
<!--                <svg class="icon"><use href="/icons/gallery.svg#profile"/></svg>-->
    ...
    `];Ke([U()],ie.prototype,"profile",2);Ke([Lt({context:Ft,subscribe:!0}),g({attribute:!1})],ie.prototype,"user",2);ie=Ke([_("site-header")],ie);var Wn=Object.defineProperty,Jn=Object.getOwnPropertyDescriptor,Kn=(r,e,t,s)=>{for(var n=s>1?void 0:s?Jn(e,t):e,i=r.length-1,o;i>=0;i--)(o=r[i])&&(n=(s?o(e,t,n):o(n))||n);return s&&n&&Wn(e,t,n),n};let Be=class extends v{render(){return f`
    ...
    `}_handleAvatarSelected(r){const t=r.target.files[0];console.log("SELCTED FILE",t),new Promise((n,i)=>{const o=new FileReader;o.onload=()=>n(o.result),o.onerror=l=>i(l),o.readAsDataURL(t)}).then(n=>this.newAvatar=n)}_handleSubmit(r){var t;r.preventDefault();const{avatar:e}=this.profile;if(this.profile){const s=r.target,n=new FormData(s);let i=Array.from(n.entries()).map(([l,a])=>a===""?[l]:[l,a]).map(([l,a])=>l==="genres"||l==="mediums"?[l,a.split(",").map(c=>c.trim())]:[l,a]);this.newAvatar?i.push(["avatar",this.newAvatar]):i.push(["avatar",e||""]);const o=Object.fromEntries(i);console.log("Submitting Form",o),this.dispatchMessage({type:"ProfileSaved",userid:(t=this.profile)==null?void 0:t.userid,profile:o})}}};qe.styles=[...I.styles,b`
      form {
        display: contents;
      }
      button {
